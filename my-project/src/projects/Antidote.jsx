      ...
      <div className="relative w-full ">
        ...
        <div className="lg:sticky sticky-none top-[80px] mix-blend-difference z-10">
          <div className="w-full px-4 sm:pl-[40px] sm:w-[90%] md:w-[70%] xl:w-[40%] text-white 2xl:mt-[90px] xl:mt-[80px]  mt-[50px] gap-4 text-[12px] sm:text-[14px] xl:text-[14px] z-10 flex flex-col">
            <p>
              Antidote by FNM is a modern, visually immersive web experience
              designed to showcase bold branding and strong digital
              storytelling. The project focuses on clean layouts, smooth
              interactions, and a refined user interface that enhances
              engagement while maintaining performance and responsiveness across
              devices.
            </p>

            <p>
              The design blends structured composition with subtle motion to
              create depth and flow, delivering an intuitive and aesthetically
            ...
            <p className="mb-2">
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>
                  <strong>REST API architecture</strong>
                </li>
                <li>
        ...
        <div className="w-full flex flex-col gap-10 sm:gap-[60px] xl:mt-[1vw] mt-[20vw] px-4 sm:px-[40px] pb-[50px]">
          ...
          <div className="flex justify-end">
            <img
              src="./Antidote/antidote_img2.png"
          ...
          <div className="flex justify-center">
            <img
              src="./Antidote/antidote_img3.png"
              className="w-full sm:w-[90%] md:w-[60%] xl:w-[34%] object-cover rounded-2xl border-black border-[2px]"
              alt="Antidote 3"
            />
          </div>
...
export default transition(Antidote);
