  ...
  return (
    <div className="bg-white pl-[60px]">
      ...
      <div className="relative w-full ">
        ...
        <div className="lg:sticky sticky-none top-[80px] mix-blend-difference z-10">
          <div className="w-full px-4 sm:pl-[40px] sm:w-[90%] md:w-[70%] xl:w-[40%] text-white 2xl:mt-[90px] xl:mt-[80px]  mt-[50px] gap-4 text-[12px] sm:text-[14px] xl:text-[14px] z-10 flex flex-col">
            <p>
              Ayodele Art is a collection of digital art pieces that explore the
              intersection of technology and creativity. Each piece is a unique
              representation of the artist's vision, blending traditional art
              techniques with modern digital tools.
            </p>

            <p>
              The collection features a variety of styles and themes, from
              abstract compositions to intricate illustrations. Each piece is
              designed to evoke emotion and provoke thought, inviting viewers to
            ...
            <Link
              to="https://ayodelart.jabulaniportfolio.space"
      ...
      <div className="w-full flex flex-col sm:flex-row justify-center items-center text-[24px] sm:text-[32px] md:text-[50px] gap-6 sm:gap-10 font-extrabold mt-[80px] sm:mt-[100px] pb-[80px]">
        {/* <h1
          onClick={handlePrev}
          className="cursor-pointer hover:text-[#9ead85] hover:scale-105 transition duration-300"
        >
          back
        </h1> */}
...
export default transition(AyodeleArt);
