        ...
        <div className="step-counter ml-[80px] lg:mt-[40px] mt-[80px]">
          ...
          <div className="count lg:flex hidden">
            <div className="count-contain" ref={countContainRef}>
              <h1 className="text-[#797979]">N.I.L</h1>
              <h1 className="text-[#797979]">CFL</h1>
              <h1 className="text-[#797979]">Hemisphere</h1>
              <h1 className="text-[#797979]"></h1>
              <h1 className="text-[#797979]"></h1>
            </div>
          </div>
        </div>
          ...
          <div className="cardd" ref={(el) => (cardsRef.current[2] = el)}>
            ...
            >
              <img
                ...
                className="img-cardd border-black border-[2px] rounded-2xl"
              />
            </Link>
          </div>

          <div className="cardd" ref={(el) => (cardsRef.current[3] = el)}>
            <Link  className="cardd-img image-hover-target cursor-pointer">
              <div
