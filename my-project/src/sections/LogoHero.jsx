  ...
  return (
    <div className="">
      <div className="intro mt-[60px] ml-[73px] h-[50vh] overflow-hidden  border-black border-b-[1px]">
        <h1 className="absolute w-full h-[50vh] flex justify-center items-center text-center pr-[10%] md:pr-0 2xl:text-[245px] lg:text-[160px] sm:text-[100px] text-[80px] text-[#a72608] font-semibold ">
          Logo
        </h1>
        <div className="mix-blend-difference flex flex-col text-white leading-[30px]">
         <div className="flex mr-8 md:mr-8 justify-between">
            {[...Array(70)].map((_, i) => (
              <div
