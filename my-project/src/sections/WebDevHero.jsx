  ...
  return (
    <div className="">
      <div className="intro mt-[60px] ml-[73px] h-[50vh] overflow-hidden  border-black border-b-[1px]">
        <h1 className="absolute w-full h-[50vh] flex justify-center items-center text-center pr-[10%] md:pr-0 2xl:text-[245px] lg:text-[160px] sm:text-[100px] text-[60px] md:leading-[120px] leading-[70px]  text-[#090c02] font-semibold ">
          web developed
        </h1>
